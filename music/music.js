document.addEventListener('DOMContentLoaded', () => {
    const musicProjects = [
        { title: "02/10/2024", file: "Project_1006.mp3" },
        ...
        { title: "03/22/2024", description: "As I was gathering all the songs I kept listening to this one, I dont really like the synth but other than that its pretty good IMO!", file: "Project_12.mp3", favorite: true },
        { title: "04/08/2024 -V1", description: "Was this most likely just a miss export? We'll never know...", file: "Project_17 (2).mp3" },
